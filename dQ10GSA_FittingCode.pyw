...
class Fitting(Tk):
    ...
    def __init__(self, *args, **kwargs):
        ...
        self.title('dQ10+GSA Fitting - Vesion:{}'.format(self.__version__))
        ...
        ### Title
        ttk.Label(self, text="Qd10+GSA Fitting", font=('arial', 30, 'bold')).pack(pady=10)
        ...
        lb_fit = ttk.Label(text='Fitted Parameters',style='Wild.TLabel')
        ...
        lb_box = ttk.Label(text='Input Data and Fitting',style='Wild.TLabel')
